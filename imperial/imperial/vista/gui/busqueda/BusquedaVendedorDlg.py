...
class BusquedaVendedorDlg(BusquedaGenericaDlg):
    u"""Diálogo para buscar ventas."""
    
    def __init__(self, modelo, parent=None):
        super(BusquedaVendedorDlg, self).__init__(modelo, parent)
        
        self.setWindowTitle(u'Búsqueda de vendedores')
        self.busquedaLabel.setText(u'Vendedor:')
